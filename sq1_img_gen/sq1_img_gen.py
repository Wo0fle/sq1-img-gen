                        ...
                        rx.center(
                            rx.vstack(
                                ...
                                rx.vstack(
                                    ...
                                    rx.hstack(rx.text("Left side color:"), rx.input(name="leftcolor", placeholder="Default: 0, 73, 255", value=FormState.leftcolor, on_change=lambda value: FormState.handle_change("boleftcolorrdercolor", value)), rx.box(width="15px", height="15px", border="1px solid gray", border_radius="50%", background_color=f"rgb({FormState.leftcolor})")),
